...
public class Conta
{
    ...
    {
        if( this.valorDaConta > valorDoSaque * 100.0 )
        {
            this.valorDaConta = Math.round( (valorDaConta - valorDoSaque) * 100.0) / 100.0;
    ...
    {
        return ("A conta" + this.nome + " " + this.agencia + " / " + this.conta + " possui R$" + this.valorDaConta);
    }
}
